" Modified version of the onedark theme
...
let s:p.normal.error = [ [ s:red, s:visual_grey ] ]
let s:p.normal.hint = [ [ s:purple, s:visual_grey ] ]
let s:p.normal.warning = [ [ s:yellow, s:visual_grey ] ]

let g:lightline#colorscheme#baptonedark#palette = lightline#colorscheme#flatten(s:p)
